...
;;  'lisp-mode-hookp
;;   (lambda()
;;     (define-key lisp-mode-map (kbd "C-c j") 'ds-jump-symbol-at-point)
;;     (define-key lisp-mode-map (kbd "C-c C-j") 'ds-jump-symbol-at-point)    
;;     (define-key lisp-mode-map (kbd "C-c b") 'ds-jump-back)
;;     (define-key lisp-mode-map (kbd "C-c C-b") 'ds-jump-back)))
