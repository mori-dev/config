...
;; (setq anything-c-source-pick-up-command
;;   `((name . "Sample-Action")
;;     (candidates . ,(phpcmp-make-completion-sources))
;;     (type . command)))



;; (setq hoge '("markdown-mode" "php-mode" "emacs-lisp-mode"))
;; (defun a ()
;;  "anything-sample"
;;   (interactive)
;;   (anything (list anything-c-source-pick-up-command) (phpcmp-get-initial-input) nil nil))
