...
(defun js-doc-make-tag-list (alist)
  (let ((taglist '()))
    (dolist (tagpair alist)
...
(defun js-doc-insert-tag ()
  ...
  (when (js-doc-in-document-p (point))
    (let ((tag (completing-read "Tag: " (js-doc-make-tag-list js-doc-all-tag-alist) nil nil nil nil
                                nil)))
...
(defun js-doc-describe-tag ()
  ...
  (interactive)
  (let ((tag (completing-read "Tag: " (js-doc-make-tag-list js-doc-all-tag-alist) nil t
    ...
    (unless (string-equal tag "")
      (with-output-to-temp-buffer "JsDocTagDescription"
        (princ (format "@%s\n\n%s" tag (cdr (assoc tag js-doc-all-tag-alist))))))))

(defun js-doc-describe-tag-echo-erea ()
  "Describe the JsDoc tag at echo area"
  (interactive)
  (let ((tag (completing-read "Tag: " (js-doc-make-tag-list js-doc-all-tag-alist)
